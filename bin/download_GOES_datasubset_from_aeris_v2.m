function datasub = download_GOES_datasubset_from_aeris_v2(SateDataDir, data_source, scene_center, scene_timevec, scene_radius, channel)
...
% catch
    ...
    datasub = read_netCDF_subsets_v2(xcen,ycen, scene_radius, t0, scene_timevec, SateDataDir, data_source,channel);

    

    datasub.source = data_source; 
